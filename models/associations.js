...
Owner.belongsToMany(Car, { through: OwnedCars, foreignKey: 'owner_id' });
Car.belongsToMany(Owner, { through: OwnedCars, foreignKey: 'car_id' });

// Car-Parts relationship through cars_parts
Car.belongsToMany(Part, { through: CarsParts, foreignKey: 'car_id' });
Part.belongsToMany(Car, { through: CarsParts, foreignKey: 'part_id' });
